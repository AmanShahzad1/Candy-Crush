...
namespace Game
{
	...
	{
		cout << setw(85) << "Table Created By Aman\n" << endl; // setw(n) gives n amount of spaces including the character to it
		cout << setw(82) << "Designed By Tallal\n" << endl;
		cout << setw(87) << "Matcher Created By Aman\n" << endl;
		cout << setw(109) << "Find Possible Number of Swaps Created By Aman\n" << endl;
		cout << setw(86) << "Bomb Created By Tallal\n" << endl;
		cout << setw(94) << "Score System Created By Tallal\n" << endl;
		SetConsoleTextAttribute(h, 15);
